...
class CustomBatchNorm1d:
    ...
    def __call__(self, input_tensor):
        if not self.training_mode:
            ...
            self.running_mean = (1 - self.momentum) * math_expect + self.momentum * self.running_mean
            self.running_var = (1 - self.momentum) * dispersion * self.brassel_correction + self.momentum * self.running_var
